...
@WebServlet(urlPatterns = "/souvenir/review/write")
public class BoardReviewWriteSouvenirController extends HttpServlet{
...
//		}
		...
		req.getRequestDispatcher("/WEB-INF/views/board/board-souvenir-review-write.jsp").forward(req, resp);
	}
